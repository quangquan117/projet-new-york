...
export const template = {
    ...
    printF() {
        ...
        for (let index in Description) {
            if (index == "Image") this.el.innerHTML += `<li itemprop="image"><img src="${Description[index]}" alt="Image de New York" itemprop="image"></li>`;else this.el.innerHTML += `<li itemprop="description">${Icon[index]}<b> ${index} :</b> ${Description[index]}</li>`;
        }
        this.el.innerHTML += "</ul>";
